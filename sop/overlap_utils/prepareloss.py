...
def point2node_correspondences(src_nodes, src_points, tgt_nodes, tgt_points, point_correspondences, thres=0., device='cuda'):
    '''
    ...
    node_corr = node_corr_mask[:-1, :-1].nonzero()  # 得到节点的索引
